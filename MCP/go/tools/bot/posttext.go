...
func PosttextHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/bot/%s/alias/%s/user/%s/text", cfg.BaseURL, botName, botAlias, userId)
		...
		var result models.PostTextResponse
...
func CreatePosttextTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_bot_botName_alias_botAlias_user_userId_text",
		...
		mcp.WithString("inputText", mcp.Required(), mcp.Description("Input parameter: The text that the user entered (Amazon Lex interprets this text).")),
		mcp.WithObject("requestAttributes", mcp.Description("Input parameter: <p>Request-specific information passed between Amazon Lex and a client application.</p> <p>The namespace <code>x-amz-lex:</code> is reserved for special attributes. Don't create any request attributes with the prefix <code>x-amz-lex:</code>.</p> <p>For more information, see <a href=\"https://docs.aws.amazon.com/lex/latest/dg/context-mgmt.html#context-mgmt-request-attribs\">Setting Request Attributes</a>.</p>")),
		mcp.WithObject("sessionAttributes", mcp.Description("Input parameter: <p>Application-specific information passed between Amazon Lex and a client application.</p> <p>For more information, see <a href=\"https://docs.aws.amazon.com/lex/latest/dg/context-mgmt.html#context-mgmt-session-attribs\">Setting Session Attributes</a>.</p>")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    PosttextHandler(cfg),
	}
}

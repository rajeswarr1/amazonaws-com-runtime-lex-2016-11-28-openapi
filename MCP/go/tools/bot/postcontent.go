...
func PostcontentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/bot/%s/alias/%s/user/%s/content#Content-Type", cfg.BaseURL, botName, botAlias, userId)
		...
		if val, ok := args["x-amz-lex-session-attributes"]; ok {
			req.Header.Set("x-amz-lex-session-attributes", fmt.Sprintf("%v", val))
		}
		...
		if val, ok := args["x-amz-lex-active-contexts"]; ok {
			req.Header.Set("x-amz-lex-active-contexts", fmt.Sprintf("%v", val))
		}
		...
		var result models.PostContentResponse
